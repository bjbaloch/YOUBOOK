part of passenger_splash_screen;

class _PassengerSplashScreenState extends State<PassengerSplashScreen>
  ...
  late PassengerSplashData _data;
  String _currentStatus = 'Finding your ride...';
      ...
      builder: (context, child) {
        return Opacity(
          ...
          child: Transform.translate(
            offset: Offset(0, (1 - _textOpacityAnimation.value) * 30),
            child: Column(
              children: [
                ShaderMask(
  ...
  Future<void> _initializeApp() async {
    try {
      ...
      if (authProvider.isAuthenticated) {
        // Passenger authenticated, navigate to passenger dashboard
        _navigateToPassengerDashboard();
      } else {
        // Not authenticated, navigate to login
        _navigateToLogin();
      }
    } catch (e) {
      debugPrint('Passenger splash screen initialization error: $e');
      setState(() {
  ...
  void _navigateToPassengerDashboard() {
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (_) => const PassengerHomeUI(data: PassengerHomeData()),
      ),
    );
  }
  ...
  void _navigateToLogin() {
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (_) => const Text('Login Screen')),
    );
  }
