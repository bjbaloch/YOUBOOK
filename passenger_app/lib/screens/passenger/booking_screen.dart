...
import '../../features/booking/UI/booking_ui.dart';
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          ...
          drawer: AppSidebarDrawer(
            ...
            selectedIndex: 3, // Booking tab selected
            onLogout: () {
          ...
          body: const SafeArea(child: MyBookingPageUI()),
  ...
  Widget _bottomNav() {
    ...
    return ClipRRect(
      ...
      child: BottomNavigationBar(
        ...
        currentIndex: 1, // Booking tab selected
        onTap: (i) {
          switch (i) {
            case 0:
              Navigator.pushReplacement(
                context,
                PassengerHomeLogic.smoothTransition(
                  PassengerHomeUI(data: const PassengerHomeData()),
                ),
              );
              break;
            case 2:
