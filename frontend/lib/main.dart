        ...
        try {
          ...
          print('DEBUG: Cleared pending confirmation data');
            ...
            if (currentUser != null) {
              ...
              // Since AuthProvider is not fully initialized, let's use Supabase directly
              ...
              } else if (profileResponse['role'] == 'manager') {
                // signed up as manager, no application submitted yet
