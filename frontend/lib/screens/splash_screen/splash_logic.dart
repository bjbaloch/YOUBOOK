...
class _SplashScreenState extends State<SplashScreen>
  ...
  Future<void> _navigateToNextScreen(AuthProvider authProvider) async {
    ...
    if (pendingEmail != null && pendingRole != null && supabaseUser != null) {
          ...
          case AppConstants.roleManager:
            ...
            if (hasSubmittedApplication) {
              ...
              if (isApproved) {
                ...
                defaultScreen = const ManagerHomeUI(data: ManagerHomeData());
              } else {
      ...
      // Navigate based on manager application status
      try {
        final application = await _authService.getManagerApplication();
        if (application != null) {
        ...
        } else if (authProvider.userRole == AppConstants.roleManager) {
          // signed up as manager, no application
          nextScreen = const ManagerCompanyDetailsScreen();
        } else {
          nextScreen = const PassengerHomeUI(data: PassengerHomeData());
        }
