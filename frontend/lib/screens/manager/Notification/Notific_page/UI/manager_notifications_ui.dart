...
class ManagerNotificationsPageUI extends StatelessWidget {
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            leading: IconButton(
              ...
              onPressed: () => ManagerNotificationsLogic.handleBackPress(context),
            ),
            centerTitle: true,
            title: Text(
              'Notifications',
            ...
            actions: [
              Padding(
                ...
                child: InkWell(
                  onTap: () => ManagerNotificationsLogic.showClearDialog(context),
