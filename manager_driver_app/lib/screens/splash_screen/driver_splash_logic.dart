part of driver_splash_screen;


class _DriverSplashScreenState extends State<DriverSplashScreen> with TickerProviderStateMixin {
  ...
  String _currentStatus = 'Starting engine...';
  ...
  Future<void> _initializeApp() async {
    try {
      ...
      if (authProvider.isAuthenticated) {
        ...
        if (user?.role == 'driver') {
          // Driver authenticated, navigate to driver dashboard
          _navigateToDriverDashboard();
        } else {
          // Not a driver, navigate to appropriate screen
          _navigateToNonDriverScreen();
        }
      } else {
      ...
      debugPrint('Driver splash screen initialization error: $e');
      setState(() {
  ...
  void _navigateToNonDriverScreen() {
    if (!mounted) return;
