  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: _data.manifest == null ? _buildNoTripView() : _buildTripView(),
        ),
                  ...
                  child: Row(
                    children: [
                      ...
                      _buildStatusIndicator(
                        ...
                        color: cs.onPrimary,
                        label:
                            '${_data.checkedInCount}/${_data.totalPassengers}',
                      ),
                    ],
                  ),
                ),
  ...
  Widget _buildTripView() {
    return Column(
      children: [
        ...
        // Passenger Manifest
        Expanded(child: _buildPassengerManifest()),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.directions_bus, color: cs.primary, size: 28),
